    ...
    <Section id="Services">
      <div className="container relative z-1">
        ...
        <div className="flex flex-wrap gap-10 mb-10">
          {benefits.map((item) => (
            <div
              className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem] overflow-hidden group"
              style={{ backgroundImage: `url(${item.backgroundUrl})` }}
              key={item.id}
            >
              {/* Content inside card */}
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] bg-opacity-90 group-hover:bg-opacity-100 transition-all duration-300">
